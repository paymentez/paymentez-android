...
Add this line to your app's `build.gradle` inside the `dependencies` section:
    ...
    compile 'com.paymentez.paymentezsdk:paymentezsdk:1.0.8'
...
http://d20omjwo1khove.cloudfront.net/ccapi/paymentez-example.apk
...
Note:
If You want to change the title, success and error messages.

Add to your resource strings.xml the following:

```
<string name="paymentez_addcard_header_title">Add Card</string>
<string name="paymentez_addcard_success_message">Card registered successfully</string>
<string name="paymentez_addcard_error_message">Card not registered successfully </string>
```


If You want to change the background color in the header.

Add to your resource colors.xml the following:

```
<string name="paymentez_addcard_header_background">***REMOVED***8bc34a</string>
```
...
```
***REMOVED******REMOVED******REMOVED*** Verify  Transaction With Code
```java
...
```
***REMOVED******REMOVED******REMOVED*** Verify  Transaction With Amount
```java
paymentezsdk.verifyWithAmount(textTransactionId.getText().toString(), textUid.getText().toString(), Double.parseDouble(textVerificationCode.getText().toString()), new VerifyResponseHandler() {
