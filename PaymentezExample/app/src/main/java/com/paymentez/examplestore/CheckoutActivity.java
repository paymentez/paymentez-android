...
public class CheckoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Paymentez paymentez = new Paymentez(this, Constants.PAYMENTEZ_IS_DEV_ENVIRONMENT, Constants.PAYMENTEZ_APP_CODE, Constants.PAYMENTEZ_APP_SECRET_KEY);
        ...
        buttonPlaceOrder.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if(CARD_TOKEN == null || CARD_TOKEN.equals("")){
                    ...
                    backendService.createCharge(Constants.USER_ID, paymentez.getSessionId(),
